  ...
  const submitSalary = async () => {
    ...
    try {
      ...
      if (checkRes.data && checkRes.data.length > 0) {
        alert(`Salaries already generated for ${monthLabel} ${generateForm.year}`);
        setLoading(false);
        return;
      }
    ...
    <div className="salary-management-container">
      ...
      <div className="salary-content">
        ...
        <div className="salary-card salary-card-generate">
          <div className="card-header">
            <div className="card-title">
              <div className="card-title-icon card-title-icon-orange">
                <Zap size={16} />
              </div>
        ...
        <div className="salary-card salary-card-search">
          <div className="card-header">
            <div className="card-title">
              <div className="card-title-icon card-title-icon-pink">
                <Search size={16} />
              </div>
        ...
        {displayResults.length === 0 && result !== null && (
          <div className="empty-state">
            <div className="empty-icon">
              <Search size={48} strokeWidth={1} color="#FFD4C0" />
            </div>
        ...
        {result === null && (
          <div className="empty-state">
            <div className="empty-icon">
              <FileText size={48} strokeWidth={1} color="#FFD4C0" />
            </div>
